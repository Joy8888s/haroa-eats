...
/* =====================================================
   ...
   IMPORTANT:
   No OTP SIGNUP.
   First successful OTP login automatically
...
app.post(
  ...
  async function(
    ...
    try{
      ...
      /*
        Existing admin/rider cannot
        enter through customer OTP.
      */
      ...
      /*
        NEW CUSTOMER:
        OTP verification successful হলে
