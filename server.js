...
/* =====================================================
   EXTRACT PHONE FROM MSG91 RESPONSE
===================================================== */
...
/* =====================================================
   OTP LOGIN
   ONE OTP = LOGIN + AUTOMATIC SIGNUP
===================================================== */
...
app.post(
  ...
  async (
    ...
    try {
      ...
      /*
       * Try both MSG91 response and
       * JWT payload for the phone.
       */
      ...
      /*
       * Admin/Rider must use Staff Login.
       */
