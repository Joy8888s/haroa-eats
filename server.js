...
/* =====================================================
   MSG91 DIRECT OTP CONFIG

   IMPORTANT:
   Customer OTP-এর জন্য Widget ব্যবহার হচ্ছে না।
   CAPTCHA ব্যবহার হচ্ছে না।
...
/* =====================================================
   MSG91 RESPONSE HELPER
===================================================== */

async function readMsg91Response(response) {
...
async function sendMsg91Otp(phone) {
  ...
  if (!MSG91_AUTHKEY) {
    ...
    throw new Error(
      "MSG91_AUTHKEY Render Environment-এ সেট করা নেই"
    );
  }
  ...
  if (!MSG91_TEMPLATE_ID) {
    ...
    throw new Error(
      "MSG91_TEMPLATE_ID Render Environment-এ সেট করা নেই"
    );
  }
...
app.post(
  ...
  async (req, res) => {
    ...
    try {
      ...
      /*
        Admin/Rider OTP login করতে পারবে না.
      */
      ...
      /*
        Customer account না থাকলে
        প্রথম সফল OTP login-এর সময়
        automatically account তৈরি হবে।
      */
